...
#ifdef WIN32
  #ifdef CHARLIEPLUGIN_EXPORTS
    #define CHARLIEPLUGIN_IMPEXP __declspec(dllexport)
  #elif CHARLIEPLUGIN_IMPORTS
    #define CHARLIEPLUGIN_IMPEXP __declspec(dllimport)
  #else
    #define CHARLIEPLUGIN_IMPEXP __declspec()
  #endif
